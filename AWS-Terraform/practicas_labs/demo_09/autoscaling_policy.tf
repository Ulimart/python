### scale up alarm
### Esta alarma lo que hará es subira una instancia si nuestra carga de CPU es mayor
...
resource "aws_cloudwatch_metric_alarm" "cpu-alarm" {
  ...
  dimensions = {
    "AutoScalingGroupName" = aws_autoscaling_group.group-autoscaling.name
  }
...
### scale down alarm
### En este caso se quitará una instancia si nuestro CPU está dentro de los parametros 
